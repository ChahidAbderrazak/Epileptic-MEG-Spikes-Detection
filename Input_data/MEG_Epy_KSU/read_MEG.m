...
fprintf('\n loading Each electrod seperatelly.')
    ...
    %% Save data
    save(strcat(Results_path,'/Spikes',SE_case,'_electrode_',num2str(Sig2study),'.mat'),'fs','y','y0','nb_slice','t','noisy_file','original_file','SNR_dB','Sig2study','Electrode','SE','Time_spike', 'Spike_startes','Spike_stops')
    end
end
