...
%% Save the PWM classification results
    ...
    save(strcat('./Classification_results/',feature_type,noisy_file,pwm_param,suff,'_norm',num2str(Normalization),'_',CV_type,'_',type_clf,'_Acc',num2str(Acc_op),'.mat'),'pwm_param','feature_TAG','perform_output', 'noisy_file','*_all','list_*','*pd','mu0','sigma0',...
                                                                          'PWM_op_results','Xs*','X','y','L_max','suff','filename')                                                                                                                    
