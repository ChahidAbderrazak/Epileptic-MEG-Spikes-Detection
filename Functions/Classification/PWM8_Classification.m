...
%     s = RandStream('mlfg6331_64'); Rndm_idx=randsample(s,size(Xsp,1),size(Xsp,1),false);
%     Xsp_Z=Xsp(Rndm_idx(1:1000),:);  Xsp_pd = fitdist(Xsp_Z(:),'Normal');
%     
%     s = RandStream('mlfg6331_64'); Rndm_idx=randsample(s,size(Xsp0,1),size(Xsp0,1),false);
%     Xsp0_Z=Xsp0(Rndm_idx(1:1000),:); Xsp0_pd = fitdist(Xsp0_Z(:),'Normal');
