...
colnames={'h','norm','Number_SCSA_features','Selected_Features','Vector_Size','Accuracy','Sensitivity','Specificity','Precision','Gmean','F1score0'};
...
% A = Output_results;
% sheet = 1;
% xlswrite(strcat(root_folder,'/',feature_type,'.xlsx'),A,sheet);
% mtrix2excel(feature_type,A,colnames,sheetnames);
